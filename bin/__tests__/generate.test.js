...
describe('generateResource()', () => {
    ...
    it('should generate resource files in correct location', async () => {
        ...
        const base = './src/user';
        expect(fs_1.default.existsSync(`${base}/user.model.ts`)).toBe(true);
        expect(fs_1.default.existsSync(`${base}/user.service.ts`)).toBe(true);
        expect(fs_1.default.existsSync(`${base}/user.controller.ts`)).toBe(true);
        expect(fs_1.default.existsSync(`${base}/user.route.ts`)).toBe(true);
        expect(fs_1.default.existsSync(`${base}/user.test.ts`)).toBe(true);
    });
});
